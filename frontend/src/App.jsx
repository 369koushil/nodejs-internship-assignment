  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-md">
        ...
        <Button color={"bg-red-500"} hover={"bg-red-700"} content={"Git Source Code Repo"} path={"https://github.com/369koushil/nodejs-internship-assignment"}></Button>
        <Button color={"bg-green-500"} hover={"bg-green-700"} content={"Postman Collection"} path={"https://web.postman.co/workspace/My-Workspace~4de7ad93-3c6e-45af-88fd-d573d7e896e0/collection/37753169-b81acbf0-6eea-41bb-a3c3-208373a2b951"}></Button>
        <Link to="/add-school">
